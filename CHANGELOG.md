...
* Added `(protosearch.index)` extension to manage index configuration.
* Infer `google.protobuf.Timestamp` protobuf fields as `date` fields.

### Changed

* **BREAKING:** Renamed the field extension back to `(protosearch.field)`.
